...
module AppOpticsAPM
  ...
  module Config
    ...
    def self.[](key)
      if key == :resque
        AppOpticsAPM.logger.warn '[appoptics_apm/deprecated] :resque config is deprecated.  It is now split into :resqueclient and :resqueworker.'
        AppOpticsAPM.logger.warn "[appoptics_apm/deprecated] Called from #{Kernel.caller[0]}"
      end
